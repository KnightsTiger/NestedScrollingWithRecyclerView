package com.xsample.nestedscrollingwithrecyclerview.behaviour;
...
public class CustomBehaviour extends CoordinatorLayout.Behavior<NestedScrollView> {
    ...
    public boolean onLayoutChild(@NonNull CoordinatorLayout parent, @NonNull NestedScrollView child, int layoutDirection) {
        ...
        setTopMargine(child.findViewById(R.id.card_view),fabHalfHeight);
        int rvMaxHeight = child.getHeight()-fabHalfHeight-child.findViewById(R.id.card_title).getHeight()-child.findViewById(R.id.card_sub_title).getHeight();
    ...
    private void setTopMargine(View view, int top) {
